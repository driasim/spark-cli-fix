...
SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-launch-2026-05-13-spawner-privacy-r2}"
SPARK_DEFAULT_CLI_REF="4600c699a7695d55a37580a92407db80277fa98a"
